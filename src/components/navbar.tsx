...
export function Navbar({ isSolid = false }) {
  ...
  return (
    <MTNavbar
      ...
      className="fixed top-0 z-50 border-0 shadow"
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          <Link href="/">
            Happy Code
            <br />
            <small>Unidade Petrópolis</small>
          </Link>
        </Typography>
        <ul
        ...
        <div className="hidden items-center lg:flex gap-2">
          <a href="#devlog">
            <Button className="bg-green-500">Games</Button>
          </a>
        </div>
        <IconButton
      ...
      <Collapse open={open}>
        <div className="container mx-auto mt-4 rounded-lg bg-white px-6 py-5">
          ...
          <div className="mt-6 flex items-center gap-4">
            <a href="#devlog">
              <Button className="esmerald" color="gray">
                Games
              </Button>
            </a>
          </div>
